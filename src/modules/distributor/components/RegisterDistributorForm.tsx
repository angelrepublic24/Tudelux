...
import { RegisterDistributorFormType, RegisterDistributorSchema } from "../../auth/schemas/auth.schema";
import { ErrorMessage } from "@/shared/components/ui/ErrorMessage/ErrorMessage";
import { useRegisterDistributor } from "../services/distributor.service";
...
export default function RegisterDistributorForm() {
  ...
  const { mutate: submitRegister, isPending } = useRegisterDistributor()
